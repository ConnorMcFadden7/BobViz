...
public class Colour extends AbstractColorChooserPanel
    ...
    protected void buildChooser() {
        ...
        final int CBG_ROW_COUNT = 3; // Colour Buttons Group Row Count
        final int CBG_COLUMN_COUNT = 4; // Colour Button Group Column Count
        final int CB_HEIGHT = 20; // Colour Button Height
        final int CB_WIDTH = 20; // Colour Button Width
