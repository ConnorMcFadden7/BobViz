...
implements ActionListener, ChangeListener {
    ...
    private boolean setupGUI(  ) {
        ...
        try{
            ...
            String[] colourSchemesBoxNames = new String[3];
            colourSchemesBoxNames[0] = "Scheme 1";
            colourSchemesBoxNames[1] = "Scheme 2";
            colourSchemesBoxNames[2] = "Scheme 3";
    ...
    private static Color[][] m_ColourSchemes = new Color[3][3];
